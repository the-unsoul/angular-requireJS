/**
 * @license AngularJS v1.3.14-local+sha.c4e6294
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.14-local+sha.c4e6294/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.14-local+sha.c4e6294',    // all of these placeholder strings will be replaced by grunt's
